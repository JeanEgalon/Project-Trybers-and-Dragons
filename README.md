# Boas vindas ao meu repositório do projeto Trybers and Dragons!

<details>
  <summary><strong>👨‍💻 O que foi desenvolvido?</strong></summary><br />

  Neste projeto apliquei os princípios da arquitetura `SOLID` e os princípios de `POO` em uma estrutura de jogos de interpretação de papéis, mais conhecidos como jogos `RPG` (_Role Playing Game_).
</details>
...
<details>
  ...
  - `git clone git@github.com:JeanEgalon/Project-Trybers-and-Dragons.git`.
